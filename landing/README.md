...
O `app.js` chama `https://api.github.com/repos/jvlustosa/postura-trabalho/releases/latest` no browser, classifica os assets por extensão (`.exe`, `.AppImage`, `.deb`, `.dmg`) e monta o card de download para o SO detectado.
